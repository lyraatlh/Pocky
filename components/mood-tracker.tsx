...
const MOODS = [
    ...
    return (
        <Card className="p-6 bg-gradient-to-br from-blue-100 via-indigo-100 to-indigo-50 dark:from-blue-950/30 dark:via-purple-950/30 dark:to-pink-950/30 border-1 border-blue-200 dark:border-blue-900">
